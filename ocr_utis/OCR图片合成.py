...
number_classes_dir = r'C:\Users\pc\Desktop\tmp\make_ocr_image\version_3_20200702\number_image\different_baground'   #数字图片文件夹
#所有标签
...
if flag == 'train':
    ...
    generate_image_num = 4000   #生成的图片数量
